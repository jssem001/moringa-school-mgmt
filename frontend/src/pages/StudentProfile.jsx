  ...
  return (
    <>
      <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div className="h-screen px-3 py-4 overflow-y-auto border-r-2 border-black"
          ...
          <ul className="space-y-2 font-semibold">
            <li>
              <div className="flex items-center p-2 text-black rounded-lg dark:text-black hover:shadow hover:bg-orange-100 group">
                <Link to='/'><span className="ms-3">Home</span></Link>
              </div>
            </li>
            <li>
              <div className="flex items-center p-2 text-black rounded-lg dark:text-black hover:shadow hover:bg-orange-100 group">
                <Link to='/projects'><span className="flex-1 ms-3 whitespace-nowrap">Projects</span></Link> {/* Add Link to Projects */}
              </div>
            </li>
            <li>
              <div className="flex items-center p-2 text-black rounded-lg dark:text-black hover:shadow hover:bg-orange-100 group">
            ...
            <li>
              <div className="flex items-center p-2 text-black rounded-lg hover:text-white hover:bg-red-700 group">
