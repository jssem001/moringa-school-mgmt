...
def seed_data():
    try:
        ...
        # Seed projects
        projects = [
            Project(name='Project Alpha', description='First project description', project_status='Completed', user_id=user_ids[0]),
            Project(name='Project Beta', description='Second project description', project_status='In Progress', user_id=user_ids[1]),
            Project(name='Project Gamma', description='Third project description', project_status='Completed', user_id=user_ids[2]),
        ]
